...
* **Logic**:
    ...
    * Validasi email dan nomor telepon harus unik
    * Validasi format request (DTO validation)
...
| `email`       | String | Valid Email, Max 30         | Email unik           |
| `phoneNumber` | String | Pattern `62xx`, 10–15 digit | Nomor telepon unik   |
| `pin`         | String | Pattern `\\d{6}`            | PIN 6 digit angka    |
...
| Nomor telepon sudah terdaftar | 200         | VYRA-EXS-001    | Account already exists       |
| Email sudah terdaftar         | 200         | VYRA-EXS-002    | Account already exists       |
